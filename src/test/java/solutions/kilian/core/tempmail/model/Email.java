package solutions.kilian.core.tempmail.model;
...
public class Email {
  ...
  protected String mailID, mailAddressID, mailFrom, mailSubject, mailPreview, mailTextOnly,
      mailText, mailHtml;
  ...
  /**
   * 
   * @return Returns the unique identifier md5 hash. This hash is used in deleting messages.
   */
  ...
  public String toString() {
    return "Email [mailTimestamp=" + mailTimestamp + ", mailID=" + mailID + ", mailAddressID="
        + mailAddressID + ", mailFrom=" + mailFrom + ", mailSubject=" + mailSubject
        + ", mailPreview=" + mailPreview + ", mailTextOnly=" + mailTextOnly + ", mailText="
        + mailText + ", mailHtml=" + mailHtml + "]";
  }
